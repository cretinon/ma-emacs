* About
Objective of this file is to have an offline reference of [[https://plantuml.com/en/deployment-diagram][PlantUML Deployment Diagram]] and [[https://plantuml.com/en/nwdiag][PlantUML Network Diagram]]. Use =C-c C-c= inside block of code to see diagrams
